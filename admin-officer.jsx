...
function PdfModal({ url, filename, onClose }) {
  ...
  return (
    <div style={{
      position:'fixed', inset:0, background:'rgba(10,5,8,.75)',
      ...
      <div style={{
        ...
        <a href={url.replace('inline=1','')} download={filename}
           style={{color:'#93c5fd',fontSize:12,textDecoration:'none',display:'flex',alignItems:'center',gap:4}}
           onClick={e=>e.stopPropagation()}>
          <Icon name="download" style={{width:14,height:14}}/> ดาวน์โหลด
        </a>
